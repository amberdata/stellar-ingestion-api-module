...
public class StellarSubscriberConfiguration {
    ...
    public StellarSubscriberConfiguration(ResourceStateStorage stateStorage,
        ...
        for (BlockchainEntityWithState<Block> block : blocks) {
            ...
            try {
                ...
                for (TransactionResponse transactionResponse : transactionResponses) {
                    List<OperationResponse> operationResponses = this.fetchOperationsForTransaction(transactionResponse);
    ...
    private Transaction enrichTransaction (TransactionResponse transactionResponse, List<OperationResponse> operationResponses) {
