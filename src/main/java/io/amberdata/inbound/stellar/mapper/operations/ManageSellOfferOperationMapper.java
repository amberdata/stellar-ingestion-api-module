...
public class ManageSellOfferOperationMapper implements OperationMapper {

  private static final Logger LOG = LoggerFactory.getLogger(ManageSellOfferOperationMapper.class);

  private AssetMapper assetMapper;

  public ManageSellOfferOperationMapper(AssetMapper assetMapper) {
  ...
  private String fetchAccountId(ManageSellOfferOperationResponse response) {
